...
3. Backend: jalankan skill `build-api` (Migration + Model + FormRequest + Policy + Controller + Resource + Route).
...
6. Testing: jalankan skill `write-tests`, minimal feature test untuk CRUD (index, store, update, destroy) + validasi + otorisasi.
