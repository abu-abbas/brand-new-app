...
2. Jalankan skill `code-review` terhadap masing-masing file/perubahan, mencakup: correctness, arsitektur layering, konvensi folder, OpenAPI/Orval, UI/UX (SweetAlert2, shadcn-vue/Element Plus), authorization, style, dan kecukupan test.
