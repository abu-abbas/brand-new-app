...
import { Shield, Mail, ArrowRight, ArrowLeft, AlertCircle, Info } from '@lucide/vue';
    ...
    >
      ...
      <div v-else>
        ...
        <div class="flex items-center gap-2.5 mb-6">
          ...
          <div>
            <h1 class="text-xl font-bold tracking-tight text-foreground">Lupa Password</h1>
            <p class="text-xs text-muted-foreground">Pemulihan akses akun internal</p>
          </div>
        </div>
