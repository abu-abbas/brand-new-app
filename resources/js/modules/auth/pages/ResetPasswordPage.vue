...
import { Lock, Eye, EyeOff, CheckCircle2, AlertCircle, ArrowRight, ArrowLeft } from '@lucide/vue';
...
<template>
  <AuthCard title="Atur Password Baru" subtitle="Lengkapi kata sandi akun Anda">
    <!-- Invalid Link State -->
    <div
      v-if="!email || !token"
    ...
    <!-- Footer Link -->
    <template v-if="email && token && !successMessage" #footer>
      <RouterLink
        to="/login"
